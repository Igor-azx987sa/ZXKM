# ZXKM  
**14.03.2024 - Тестовые прошивки поддержки джойстиков, для всех версий.**  

**12.03.2024 - Поддержка джойстиков для версий v1.0, v1.2 и  +SD v1.0,v1.1  
		пока тестовая версия. Кнопки JOY примаплены к клавиатуре, пока без возможности переназначить.**
...
**!!! При самостоятельной сборке, первым прошить Altera. т.к она блокирует пины программирования Atmega. !!!**  
...
ZXKM успешно работает на следующих компах: **Spectrum+, Scorpion GMX, Scorpion ZS 256k, Pentagon 128 классика и 2.666, Jasper, Мастер, Дельта.**  
